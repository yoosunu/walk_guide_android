...
// definition of TrackedObject
// TrackedObject는 previous와 curren인 두 Detection객체를 가지고 두 객체 간의 차이 등을
// 이용하여 의미를 부여함.
data class TrackedObject(
    ...
    fun isStable(threshold: Int = AppConfig.STABLE_FRAME_THRESHOLD): Boolean {
    ...
    fun shouldTriggerDepth(): Boolean {
        ...
        if (distFromCenter < AppConfig.DEPTH_TRIGGER_CENTER_DISTANCE) return true // 충돌 가능성 높으니 depth 필요.
